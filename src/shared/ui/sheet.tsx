/**
 * Sheet — drawer lateral baseado em Radix Dialog. Substitui o padrão de
 * "form aparecendo embaixo da lista" — o usuário mantém a lista visível
 * enquanto edita um item.
 *
 * Por que side="right" como default: forms grandes (admin/users, projetos
 * com muitos campos) cabem melhor numa coluna lateral do que num modal
 * centralizado. A lista atrás continua acessível pra contexto.
 */
