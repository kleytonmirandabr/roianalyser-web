/** Admin → Item do Catálogo (master only). */
...
import {
  useCreateCatalogItem, useDeleteCatalogItem,
  useCatalogItems, useUpdateCatalogItem,
...
export function AdminCatalogItemsPage() {
  ...
  const items = ((data ?? []) as CatalogItem[]).slice().sort((a, b) =>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Item do Catálogo</h1>
