...
import {
  useCreateSector, useDeleteSector,
  useSectors, useUpdateSector,
} from '@/features/sectors/hooks/use-sectors'
...
export function AdminSectorsPage() {
  ...
  const update = useUpdateSector(draft.id)
  ...
  async function handleDelete(item: Sector) {
    const it = item as unknown as Record<string, unknown>
    ...
    <div className="space-y-6">
      ...
      <Sheet open={open} onOpenChange={setOpen}>
        <SheetContent className="sm:max-w-lg">
          <SheetHeader><SheetTitle>{draft.id ? t('admin.sectors.titleEdit') : t('admin.sectors.titleNew')}</SheetTitle></SheetHeader>
